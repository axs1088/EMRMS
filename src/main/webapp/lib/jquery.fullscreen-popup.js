    ...
    FSP = (function() {
      ...
      FSP.prototype.createWrappers = function() {
        this.mainWrapper = $("<div/>", {
          ...
          "style": this.options.inlineStyles ? "background: " + this.options.bgColor + "; position: fixed; top: 0; left: 0; right: 0; bottom: 0; z-index: 99; overflow-y: auto; overflow-x: hidden; display: none" : void 0
        });
        ...
        return this.close = $("<a/>", {
          ...
          "style": this.options.inlineStyles ? "position: absolute; right: 1.5em; top: 7.7em; font-size: 30px; font-weight: 900; text-decoration: none;" : void 0
        }).appendTo(this.mainWrapper);
      };
