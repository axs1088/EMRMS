...
-- Script date 9/5/2017 10:40:56 PM
...
ALTER TABLE h_bed
  ADD CONSTRAINT FK_h_bed_h_location FOREIGN KEY (LocationID)
    REFERENCES h_encounter_attending_physician_h_staff(HEncounterID) ON DELETE NO ACTION ON UPDATE RESTRICT;

ALTER TABLE h_diagnosis
  ADD CONSTRAINT FK_h_diagnosis_h_encounter FOREIGN KEY (EncounterID)
    REFERENCES h_encounter_attending_physician_h_staff(HEncounterID) ON DELETE NO ACTION ON UPDATE NO ACTION;

ALTER TABLE h_diagnosis
  ADD CONSTRAINT FK_h_diagnosis_h_patient FOREIGN KEY (PatientID)
    REFERENCES h_patient(HPatientID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE h_encounter_attending_physician_h_staff
  ADD CONSTRAINT FK_h_encounter_attending_physi FOREIGN KEY (AttendingPhysician_ObjectID)
    REFERENCES h_staff(HStaffID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE h_encounter_attending_physician_h_staff
  ADD CONSTRAINT FK_h_encounter_h_bed FOREIGN KEY (Bed_ObjectID)
    REFERENCES h_bed(BedId) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE h_encounter_attending_physician_h_staff
  ADD CONSTRAINT FK_h_encounter_h_patient_Patie FOREIGN KEY (Patient_ObjectID)
    REFERENCES h_patient(HPatientID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE h_medication
  ADD CONSTRAINT FK_h_medication_h_encounter FOREIGN KEY (EncounterID)
    REFERENCES h_encounter_attending_physician_h_staff(HEncounterID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE h_medication
  ADD CONSTRAINT FK_h_medication_h_patient FOREIGN KEY (PatientID)
    REFERENCES h_patient(HPatientID) ON DELETE CASCADE ON UPDATE RESTRICT;

ALTER TABLE h_problem_list
  ADD CONSTRAINT FK_h_problem_list_h_encounter FOREIGN KEY (EncounterID)
    REFERENCES h_encounter_attending_physician_h_staff(HEncounterID) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE h_problem_list
  ADD CONSTRAINT FK_h_problem_list_h_patient FOREIGN KEY (PatientID)
    REFERENCES h_patient(HPatientID) ON DELETE CASCADE ON UPDATE CASCADE;
