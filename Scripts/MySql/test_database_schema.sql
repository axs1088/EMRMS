...
--
-- Definition for database emrms_test
--
DROP DATABASE IF EXISTS emrms_test;
CREATE DATABASE IF NOT EXISTS emrms_test
  CHARACTER SET utf8
...
--
CREATE TABLE IF NOT EXISTS h_assessment (
...
--
CREATE TABLE emrms_test.h_audit_record (
...
--
CREATE TABLE IF NOT EXISTS h_bed (
...
--
CREATE TABLE IF NOT EXISTS h_password (
...
--
CREATE TABLE IF NOT EXISTS h_address (
...
CREATE TABLE IF NOT EXISTS h_staff_to_unit_association (
  ...
  REFERENCES h_staff (HStaffID)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT FK_h_staff_to_unit_association_horg FOREIGN KEY (HealthcareOrganizationID)
  REFERENCES healthcare_organization (HealthcareOrganizationID)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = INNODB
...
CREATE TABLE IF NOT EXISTS h_user (
  ...
  REFERENCES h_password (HPasswordId)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
--
CREATE TABLE IF NOT EXISTS h_allergy (
  ...
  REFERENCES h_patient (HPatientID)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = INNODB
...
--
CREATE TABLE emrms_test.h_encounter (
...
--
CREATE TABLE IF NOT EXISTS h_patient_ids (
  HPatientId       BIGINT(20) NOT NULL AUTO_INCREMENT,
  UserId           VARCHAR(20)         DEFAULT NULL,
  CreationDateTime DATETIME            DEFAULT NULL,
  ...
  REFERENCES healthcare_organization (IdIssuer)
    ON DELETE CASCADE
    ON UPDATE CASCADE
)
  ENGINE = INNODB
...
--
CREATE TABLE IF NOT EXISTS h_diagnosis (
  ...
  REFERENCES h_encounter (HEncounterID)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
--
CREATE TABLE IF NOT EXISTS h_medication (
